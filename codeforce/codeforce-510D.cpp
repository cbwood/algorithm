/*************************************************************************
	> File Name: codeforce-510D.cpp
	> Author: wood
	> Mail: cbcruel@gmail.com
	> Created Time: 2018年09月17日 星期一 16时36分52秒
 ************************************************************************/
...
int main(){
	...
	for(int i = 1; i <= n; ++i){
		...
		splay.insert(sum);
		q.insert(sum);
		LL tmp = *q.lower_bound(sum-t+1);
		int num = splay.rank(tmp);
		ans += i - num+1;
		cout <<"num = " << i- num+1 << "tmp =  " << tmp << "sum-t+1 = " << sum-t+1 << endl;
	}cout << ans << endl;
